          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 rounded-[24px] text-white shadow-2xl relative overflow-hidden flex flex-col justify-center min-h-[480px]"
            ...
            <div className="relative z-10">
              <h1 className="text-4xl md:text-5xl font-semibold mb-4 leading-[1.2] tracking-[-0.5px]">
                <span className="block mb-2">Log in to</span>
            ...
            <div className="mt-8 text-center">
              {isSignUp ? (
                <p className="text-[14px] text-[#6B7280] font-medium">
                  Already have an account? <button onClick={(e) => { e.preventDefault(); setIsSignUp(false); }} className="text-[#6C3CF7] font-bold hover:underline">Log In</button>
                </p>
              ) : (
                <p className="text-[14px] text-[#6B7280] font-medium">
                  New here? <button onClick={(e) => { e.preventDefault(); window.location.href = '/signup'; }} className="text-[#6C3CF7] font-bold hover:underline">Create account</button>
                </p>
              )}
            </div>
