  ...
  return (
    <section ref={sectionRef} className="relative w-full pt-24 pb-12 bg-white overflow-hidden font-poppins">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10 flex flex-col gap-16">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div ref={rightRef} className="flex-1 w-full flex flex-col relative z-10 pt-4">
            ...
            <h2 className="text-[32px] md:text-[40px] font-bold text-[#1A1A2E] leading-tight mb-6">
              What Are <span className="text-[#3B82F6]">Skillzza Studios?</span>
            </h2>
        ...
        {/* Bottom Banner */}
        <div ref={bottomRef} className="w-full bg-[#F3F6FA] rounded-xl p-8 flex items-center gap-6 relative z-10 mt-12 mb-0">
          <div className="shrink-0 flex items-center justify-center">
            <svg width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M22 2L13 11" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M17 2H22V7" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              
              {/* White overlay line to make the arrow 'break' the circle outline */}
              <path d="M16 8L18 6" stroke="#F3F6FA" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M22 2L13 11" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <p className="text-[#1A1A2E] text-[16px] font-semibold leading-relaxed">
            The Learning Model Is Designed To Help Students Move From Exploration To Application<br/>
            While Building Confidence And Self-Direction.
          </p>
        </div>
