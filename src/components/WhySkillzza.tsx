        ...
        <div className="bg-slate-900 rounded-[2rem] border border-slate-800 shadow-2xl overflow-hidden relative">
          ...
          <div className="divide-y divide-slate-800">
            {comparisonData.map((row, i) => (
              ...
              >
                {/* OTHERS COLUMN */}
                <div className="py-6 px-4 lg:px-8 flex items-center gap-4 opacity-50 group-hover:opacity-30 transition-opacity">
                  <XCircle className="w-6 h-6 text-slate-600 flex-shrink-0 hidden sm:block" />
                  <span className="text-slate-400 font-medium text-sm lg:text-base line-through decoration-slate-600">
                    {row.others}
                  </span>
                </div>
