        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="w-full md:w-3/5 lg:w-3/5 text-left flex flex-col items-start justify-center">
            ...
            <div className="relative group w-full sm:w-auto">
              ...
              <a href="https://registration.skillzza.com/forms" target="_blank" rel="noreferrer" className="relative w-full sm:w-auto bg-gradient-to-b from-[#E61E1E] to-[#BD1313] border border-[#9A0F0F] text-white text-sm md:text-base font-bold px-8 py-4 rounded-xl flex items-center justify-center gap-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_4px_15px_rgba(230,30,30,0.2)] hover:-translate-y-1 transition-all duration-300 overflow-hidden">
