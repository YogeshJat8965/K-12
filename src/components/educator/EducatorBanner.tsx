    ...
    <section className="w-full bg-white py-12 md:py-24 flex justify-center font-poppins">
      <div className="w-full max-w-[1536px] mx-auto px-4 md:px-12 relative flex items-center justify-center">
        ...
        <div className="relative w-full rounded-[32px] overflow-hidden shadow-lg group">
          ...
          <div className="absolute right-[5%] md:right-[10%] top-1/2 -translate-y-1/2 flex items-center z-10">
            <button className="bg-white text-[#4F46E5] font-bold py-3 px-6 md:py-4 md:px-8 rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)] hover:-translate-y-1 hover:bg-[#F5F3FF] transition-all duration-300 flex items-center gap-2 text-[14px] md:text-[16px]">
