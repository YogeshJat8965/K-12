        ...
        <div className="text-center mb-16">
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-slate-600 text-base md:text-lg max-w-4xl mx-auto leading-relaxed">
              What starts as curiosity in the Playground naturally progresses into structured learning through Skill Studio's full ecosystem. Every agent a student builds becomes a doorway to deeper skills.
            </p>
          </ScrollReveal>
        </div>
