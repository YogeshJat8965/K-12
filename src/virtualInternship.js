...
export const stats = [
  ...
  { value: 6, suffix: "", label: "Weeks Program" },
  { value: 6, suffix: "", label: "Outcomes Earned" },
  { value: 12, suffix: "th", label: "Grade Supported" }
]
...
export const howItWorks = {
  ...
  subtitle: "A structured journey that mirrors real workplace experiences.",
  steps: [
...
export const tracks = [
  ...
  { icon: "🌍", title: "Leadership, Civic & Social Impact", tagline: "THE FUTURE LEADERS", color: "from-violet-500 to-purple-700", desc: "Civic leadership, community projects, social entrepreneurship, policy thinking, and building solutions that serve others." }
]
...
export const forSchools = {
  ...
  subtitle: "Experiential learning at scale, aligned to NEP 2020",
  points: [
    "Full alignment with NEP 2020 and skill-based education mandates.",
    "Cohort-based implementation across grades and sections.",
    "Teacher dashboards with cohort progress and outcome analytics.",
    "Student showcase opportunities and capstone presentations.",
    "Co-branded internship certification recognising your institution."
  ]
}
...
export const whySkillzza = [
  ...
  { icon: "💼", title: "Portfolio-Driven Approach", desc: "Everything produced is shareable, credible, and built for long-term impact." },
  { icon: "🔒", title: "Safe & Parent-Visible", desc: "Moderated platform with complete transparency for parents and schools." }
]
...
export const quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        { label: "🔭 Explore outer space", tracks: ["Space, Science & Frontier Tech"] },
        { label: "🎤 Speak to the world", tracks: ["Public Voice, Media & Global Affairs"] },
        { label: "🧘 Stay calm under pressure", tracks: ["Mindfulness, Wellness & Inner Growth"] },
        { label: "🌍 Lead communities", tracks: ["Leadership, Civic & Social Impact"] }
      ]
    },
    {
      q: "What's your dream outcome?",
      options: [
        { label: "📱 Build an app or product", tracks: ["AI, Data & Deep Tech", "Creative, Media & Product Design"] },
        { label: "📊 Run your own startup", tracks: ["Business, Finance & Entrepreneurship"] },
        { label: "🏅 Win recognition & awards", tracks: ["Leadership, Civic & Social Impact"] },
        { label: "🔬 Make a scientific discovery", tracks: ["Space, Science & Frontier Tech"] }
      ]
    }
  ]
}